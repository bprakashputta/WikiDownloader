...
public class WikiDownloader implements Runnable{
...
//        assert imageURL!=null;
    ...
    public static void main(String[] args) {
        //Initialise the thread count using taskmanager
        TaskManager taskManager = new TaskManager(10);
        //Keywords array to search on wikipedia.
        String[] arr = {"India","United States","Argentina","Money","Albert Einstein","Hittler","Satya Nadella","Bhanu Prakash","Rohit Sharma","Cricket Australia"};
        //for loop to iterate over the keywords and get the data from wikipedia.
        for(String keyWord : arr)
        {
            //Implement the Runnable wikiDownloader class
            WikiDownloader wikiDownloader = new WikiDownloader(keyWord);
            //Pass the runnable to taskManager
